        ...
        tr.innerHTML = `
          <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
            ...
            <td class="flex justify-evenly mt-4">
              <button id='actualizar' onclick='TraerDatos(${row.codigo})' type="button"  >
                <i class="fa-solid fa-pen-to-square text-black  hover:text-blue-400"></i>
              </button>

              <button id='eliminar' onClick='eliminarProducto(${row.codigo}'>
...
function agregarClase() {
  ...
  fetch(
    `./Controllers/agregarProductoController.php?codigo=${codigo} &nombre=${nombre} &precio=${precio} &categoria=${categoria}`
  )
    .then((response) => {
